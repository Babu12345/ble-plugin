...
use esp_idf_sys::cherry_device::{
    ...
    usbd_get_ep_mps, usbd_initialize, usbd_interface, CDC_ACM_DESCRIPTOR_LEN, USB_2_0,
    USB_BULK_EP_MPS_FS, USB_BULK_EP_MPS_HS, USB_CONFIG_BUS_POWERED, USB_DEVICE_CLASS_MISC,
    USB_SPEED_FULL, USB_SPEED_HIGH,
};

mod inits;

use crate::usb_device::inits::{
