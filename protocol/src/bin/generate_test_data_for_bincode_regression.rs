// Test data generation binary for bincode protocol regression tests
...
mod types {
    ...
    use protocol::{HostIO, IOBase, MessageType, PluginIO, DEFAULT_PACKET_SIZE, IO};
    ...
    pub fn create_test_host_commands() -> Vec<(String, Vec<u8>)> {
    ...
    pub fn create_test_plugin_responses() -> Vec<(String, Vec<u8>)> {
        let mut test_data = Vec::new();
    ...
    pub fn create_integer_type_test_data() -> Vec<(String, Vec<u8>)> {
        let mut test_data = Vec::new();
